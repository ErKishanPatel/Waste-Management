...
<div class="row">
	<div class="col-sm-12">
		<div class="box box-color box-bordered">
			...
			<jsp:include page="errorNotify.jsp"></jsp:include>
				<table class="table table-hover table-nomargin table-bordered dataTable">
					...
					<tbody>
					<c:forEach items="${sessionScope.company}" var="x">
				<tr>
		...
		<a href="<%=request.getContextPath() %>/C_Reg_Controller?flag=delete&id=${x.companyId}" class="btn" rel="tooltip" title="Delete">
