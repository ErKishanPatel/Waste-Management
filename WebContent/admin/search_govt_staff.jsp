...
<div class="row">
	<div class="col-sm-12">
		<div class="box box-color box-bordered">
			...
			<jsp:include page="errorNotify.jsp"></jsp:include>
				<table class="table table-hover table-nomargin table-bordered dataTable">
					...
					<tbody>
					<c:forEach items="${sessionScope.govt_staff}" var="x">
				<tr>
		...
		<a href="<%=request.getContextPath() %>/S_Reg_Controller?flag=edit&id=${x.govt_staffId}" class="btn" rel="tooltip" title="Edit">
			<i class="fa fa-edit"></i>
		</a>
		<a href="<%=request.getContextPath() %>/S_Reg_Controller?flag=delete&id=${x.govt_staffId}" class="btn" rel="tooltip" title="Delete">
