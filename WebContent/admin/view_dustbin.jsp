...
<head>
	...
	<!-- Favicon -->
	<link rel="shortcut icon" href="${pageContext.request.contextPath }/admin/css/favicon.ico" />
					...
					<tr>
						...
						<td>${x.dustName}  </td>
							<td class='hidden-480'>
								...
								<a href="<%=request.getContextPath() %>/Dust_Controller?flag=edit&id=${x.dustId}" class="btn" rel="tooltip" title="Edit">
									<i class="fa fa-edit"></i>
								</a>
								<a href="<%=request.getContextPath() %>/Dust_Controller?flag=delete&id=${x.dustId}" class="btn" rel="tooltip" title="Delete">
