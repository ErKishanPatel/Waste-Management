							...
							<div class="box-content nopadding">
								<form action= "<%=request.getContextPath()%>/Subcat_Controller" method="POST" class='form-horizontal form-bordered'>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<select name="categoryId" id="bbb" data-rule-required="true" class="form-control">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="subcat" id="textfield" placeholder="Text input" class="form-control">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea name="subcat_des" id="textarea" rows="5" placeholder="Write Your Text Here..." class="form-control"></textarea>
										</div>
									</div>
