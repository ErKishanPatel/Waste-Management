...
<body class='login'>
	<div class="wrapper">
		...
		<div class="login-body">
			<h2>Company</h2>
			<form action="index.jsp" method='get' class='form-validate' id="test">
				<div class="form-group">
					<div class="email controls">
						<input type="text" name='userName' placeholder="Compant Name" class='form-control' data-rule-required="true" data-rule-minlength="2">
					</div>
				</div>
				
				<div class="form-group">
					<div class="email controls">
						<input type="text" name='userName' placeholder="City" class='form-control' data-rule-required="true" data-rule-minlength="2">
					</div>
				</div>
				...
				<div class="form-group">
					<div class="email controls">
						<input type="text" name="pin" placeholder="Company Contact" id="digitsfield" class='form-control' data-rule-digits="true" data-rule-required="true" >
					</div>
				</div>
				<div class="form-group">
					<div class="email controls">
						<input type="text" name="pin" placeholder="Contact Person" id="digitsfield" class='form-control' data-rule-digits="true" data-rule-required="true" >
					</div>
				</div>
				...
				<div class="form-group">
					...
					<input type="password" name="password" placeholder="Confirm Password" id="confirmfield" class="form-control" data-rule-equalTo="#pwfield"  data-rule-required="true">
				</div>
				
				<div class="form-group">
					<div class="email controls">
						<input type="text" name='userName' placeholder="Registration No." class='form-control' data-rule-required="true" data-rule-minlength="2">
					</div>
				</div>
