...
<head>
	...
	<title>E-Governance For Trash Control</title>
	...
	<link rel="apple-touch-icon-precomposed" href="${pageContext.request.contextPath}/admin/${pageContext.request.contextPath }/admin/img/apple-touch-icon-precomposed.png" />
	...
	<div id="modal-user" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">Ã—</button>
					<h4 class="modal-title" id="myModalLabel">Pratik</h4>
				</div>
				...
				<div class="breadcrumbs">
					...
					<div class="close-bread">
						<a href="#">
							...
							<iframe src="<%=request.getContextPath() %>/admin/chart.jsp" width="100%" height="300"></iframe>
