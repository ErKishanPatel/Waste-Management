	...
	<div class="col-sm-12">
		<div class="box box-color box-bordered">
			...
			<div class="box-content nopadding">
						...
						<c:forEach items="${sessionScope.complaint }" var="x">
			...
			<jsp:include page="errorNotify.jsp"></jsp:include>
				...
				<table class="table table-hover table-nomargin table-bordered dataTable">
					...
					<tr>
						<td>${x.complaint} </td>
						<td>${x.complaintDes}  </td>
						<td class='hidden-480'>
		<a href="#" class="btn" rel="tooltip" title="View">
			<i class="fa fa-search"></i>
		</a>
		<a href="<%=request.getContextPath() %>/U_Complaint_Controller?flag=edit&id=${x.compId}" class="btn" rel="tooltip" title="Edit">
			<i class="fa fa-edit"></i>
		</a>
		<a href="<%=request.getContextPath() %>/U_Complaint_Controller?flag=delete&id=${x.compId}" class="btn" rel="tooltip" title="Delete">
