							...
							<div class="box-content nopadding">
								<form action="<%=request.getContextPath()%>/Category_Controller" method="POST" class='form-horizontal form-bordered'>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="cat" id="textfield" placeholder="Text input" class="form-control">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea name="cat_des" id="textarea" rows="5"  placeholder="Write Your Text Here..."class="form-control"></textarea>
										</div>
									</div>
