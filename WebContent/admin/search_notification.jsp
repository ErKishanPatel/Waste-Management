...
<head>
	...
	<title>Search Notification</title>
	...
	<!-- Favicon -->
	<link rel="shortcut icon" href="${pageContext.request.contextPath }/admin/${pageContext.request.contextPath }/admin/css/favicon.ico" />
		...
		<div class="box box-color box-bordered">
			...
			<div class="box-content nopadding">
				<table class="table table-hover table-nomargin table-bordered dataTable">
					...
					<tbody>
					<c:forEach items="${sessionScope.notification }" var="x">
					<tr>
