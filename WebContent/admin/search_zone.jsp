...
<div class="row">
	<div class="col-sm-12">
		...
		<a href="<%=request.getContextPath() %>/Zone_Controller?flag=edit&id=${x.zoneId}" class="btn" rel="tooltip" title="Edit">
			<i class="fa fa-edit"></i>
		</a>
		<a href="<%=request.getContextPath() %>/Zone_Controller?flag=delete&id=${x.zoneId}" class="btn" rel="tooltip" title="Delete">
