...
<div class="row">
	<div class="col-sm-12">
		...
		<a href="<%=request.getContextPath() %>/Category_Controller?flag=edit&id=${x.categoryId}" class="btn" rel="tooltip" title="Edit">
			<i class="fa fa-edit"></i>
		</a>
		<a href="<%=request.getContextPath() %>/Category_Controller?flag=delete&id=${x.categoryId}" class="btn" rel="tooltip" title="Delete">
