...
<div class="row">
	<div class="col-sm-12">
		...
		<a href="<%=request.getContextPath() %>/Subcat_Controller?flag=edit&id=${x.subcatId}" class="btn" rel="tooltip" title="Edit">
			<i class="fa fa-edit"></i>
		</a>
		<a href="<%=request.getContextPath() %>/Subcat_Controller?flag=delete&id=${x.subcatId}" class="btn" rel="tooltip" title="Delete">
