...
<head>
	...
	<!-- vmap -->
	<script src="${pageContext.request.contextPath }/admin/js/jquery.vmap.min.js"></script>
	<script src="${pageContext.request.contextPath }/admin/js/jquery.vmap.world.js"></script>
	<script src="${pageContext.request.contextPath }/admin/js/jquery.vmap.sampledata.js"></script>
	<!-- Bootbox -->
	...
	<script src="${pageContext.request.contextPath }/admin/js/jquery.flot.bar.order.min.js"></script>
	<script src="${pageContext.request.contextPath }/admin/js/jquery.flot.pie.min.js"></script>
	...
	<!-- PageGuide -->
	<script src="${pageContext.request.contextPath }/admin/js/jquery.pageguide.js"></script>
	<!-- FullCalendar -->
...
<body>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				 ...
				 <div class="modal-body">
					<div class="row">
						<div class="col-sm-2">
							<img src="${pageContext.request.contextPath }/admin/img/user-1.jpg" alt="">
						</div>
						<div class="col-sm-10">
	...
	<jsp:include page="s_navigation.jsp"></jsp:include>
						...
						<div class="box">
							...
							<div class="box-content nopadding scrollable" data-height="350" data-visible="true" data-start="bottom">
								<ul class="messages">
									...
									<li class="right">
										<div class="image">
											<img src="${pageContext.request.contextPath }/admin/img/user-2.jpg" alt="">
										</div>
										<div class="message">
											<span class="caret"></span>
									...
									<li class="typing">
										...
										<img src="${pageContext.request.contextPath }/admin/img/loading.gif" alt="">
									</li>
									<li class="insert">
							...
							<div class="box-content nopadding scrollable" data-height="300" data-visible="true">
								<table class="table table-user table-nohead">
									<tbody>
										...
										<tr>
											<td class='img'>
												<img src="${pageContext.request.contextPath }/admin/img/user-3.jpg" alt="">
											</td>
										...
										<tr>
											<td class='img'>
												<img src="${pageContext.request.contextPath }/admin/img/user-4.jpg" alt="">
											</td>
										...
										<tr>
											<td class='img'>
												<img src="${pageContext.request.contextPath }/admin/img/user-5.jpg" alt="">
											</td>
										...
										<tr>
											<td class='img'>
												<img src="${pageContext.request.contextPath }/admin/img/user-6.jpg" alt="">
											</td>
											<td class='user'>John Doe</td>
											<td class='icon'>
												<a href="#" class='btn'>
