				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3>
									<i class="fa fa-th-list"></i>Manage Zone</h3>
							</div>
							<div class="box-content nopadding">
								<form action="<%=request.getContextPath()%>/Zone_Controller" method="POST" class='form-horizontal form-bordered'>
									<div class="form-group">
										<label for="zone" class="control-label col-sm-2">Add Zone</label>
										<div class="col-sm-10">
											<input type="text" name="zone" id="textfield" placeholder="Text input" class="form-control">
										</div>
									</div>
									
									
									<div class="form-group">
										<label for="zone_des" class="control-label col-sm-2">Zone Description</label>
										<div class="col-sm-10">
											<textarea name="zone_des" id="textarea" rows="5" placeholder="Write Your Text Here..." class="form-control"></textarea>
										</div>
									</div>
