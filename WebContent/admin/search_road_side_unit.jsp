...
<head>
	...
	<title>View Road Side Unit</title>
...
<div class="row">
	<div class="col-sm-12">
		...
		<a href="<%=request.getContextPath() %>/Road_Side_Unit_Controller?flag=edit&id=${x.roadId}" class="btn" rel="tooltip" title="Edit">
			<i class="fa fa-edit"></i>
		</a>
		<a href="<%=request.getContextPath() %>/Road_Side_Unit_Controller?flag=delete&id=${x.roadId}" class="btn" rel="tooltip" title="Delete">
