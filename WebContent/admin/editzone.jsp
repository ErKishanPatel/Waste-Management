							...
							<%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
								...
								<form action="<%=request.getContextPath()%>/Zone_Controller" method="POST" class='form-horizontal form-bordered'>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" value="${x.zoneName }"name="zone" id="mm" placeholder="Text input" class="form-control">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea name="zone_des" id="mm" rows="5" placeholder="Write Your Text Here..." class="form-control">${x.zoneDes }</textarea>
										</div>
									</div>
