...
<div class="row">
	<div class="col-sm-12">
		...
		<a href="<%=request.getContextPath() %>/Area_Controller?flag=edit&id=${x.areaId}" class="btn" rel="tooltip" title="Edit">
			<i class="fa fa-edit"></i>
		</a>
		<a href="<%=request.getContextPath() %>/Area_Controller?flag=delete&id=${x.areaId}" class="btn" rel="tooltip" title="Delete">
