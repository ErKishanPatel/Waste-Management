							...
							<div class="box-content">
								<form action="<%=request.getContextPath()%>/C_Staff_Controller" method="post" class='form-horizontal form-validate' id="bb">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="staffName" placeholder=" Enter Labor Name" id="textfield" class="form-control" data-rule-required="true" data-rule-minlength="2">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea name="ad" placeholder="Residensial Address" id="textarea" class="form-control"></textarea>
										</div>
									</div>
									<div class="form-group">
										<label for="textfield" class="control-label col-sm-2">City</label>
										<div class="col-sm-10">
											<input type="text" placeholder="Enter City" name="city" id="textfield" class="form-control" data-rule-required="true" data-rule-minlength="2">
										</div>
									</div>					
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" placeholder="Only digits" name="pin" id="digitsfield" data-rule-digits="true" data-rule-required="true" class="form-control">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" placeholder="Only digits" name="contact" id="digitsfield" data-rule-digits="true" data-rule-required="true" class="form-control">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="reg_no" placeholder="Registration No." id="textfield" class="form-control" data-rule-required="true" data-rule-minlength="2">
										</div>
									</div>
