				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3>
									<i class="fa fa-th-list"></i>Edit Area</h3>
							</div>
							<div class="box-content nopadding">
							<%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>					
								<c:forEach items="${sessionScope.editarea }" var="y">
								<form action=" <%=request.getContextPath()%>/Area_Controller" method="POST" class='form-horizontal form-bordered'>
									<div class="form-group">
										<label for="textfield" class="control-label col-sm-2">Zone Name</label>
										<%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
										<div class="col-sm-10">
										<select name="zone_id"  data-rule-required="true" class="form-control">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="area"  id="textfield" placeholder="Text input" class="form-control" value="${y.areaName}" >
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea name="area_des" id="textarea" rows="5" placeholder="Write Your Text Here..." class="form-control" >${y.areaDes}</textarea>
										</div>
									</div>
