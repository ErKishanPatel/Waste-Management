...
<div class="row">
	<div class="col-sm-12">
		<div class="box box-color box-bordered">
			...
			<jsp:include page="errorNotify.jsp"></jsp:include>
				<table class="table table-hover table-nomargin table-bordered dataTable">
					...
					<c:forEach items="${sessionScope.asArea }" var="x">
					<tbody>
				<tr>
						
						<td>${x.stf.staffName}</td>
						<td>${x.lm.areaName}</td>
						<td>${x.vanNo} </td>
		...
		<a href="<%=request.getContextPath() %>/C_Assign_Area_Controller?flag=edit&id=${x.assignaId}" class="btn" rel="tooltip" title="Edit">
			<i class="fa fa-edit"></i>
		</a>
		<a href="<%=request.getContextPath() %>/C_Assign_Area_Controller?flag=delete&id=${x.assignaId}" class="btn" rel="tooltip" title="Delete">
