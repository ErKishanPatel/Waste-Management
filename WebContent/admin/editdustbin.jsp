				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3>
									<i class="fa fa-th-list"></i>Dustbin</h3>
							</div>
							...
							<c:forEach items="${sessionScope.editdustbin }" var="x">
								<form action="<%=request.getContextPath()%>/Dust_Controller" method="POST" class='form-horizontal form-bordered'>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="dust" id="textfield" placeholder="Text input" class="form-control" value=" ${x.dustNo }" >
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="dust_des" id="textfield" placeholder="Text input" class="form-control"value=" ${x.dustName }">
										</div>
									</div>
