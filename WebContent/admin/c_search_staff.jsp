...
<div class="row">
	<div class="col-sm-12">
		...
		<a href="<%=request.getContextPath() %>/C_Staff_Controller?flag=edit&id=${x.staffId}" class="btn" rel="tooltip" title="Edit">
			<i class="fa fa-edit"></i>
		</a>
		<a href="<%=request.getContextPath() %>/C_Staff_Controller?flag=delete&id=${x.staffId}" class="btn" rel="tooltip" title="Delete">
