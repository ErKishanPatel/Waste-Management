...
<html lang="en">
<head>
<title>Request For Garbage Allocation</title>
...
<section id="banner" class="inner-b"> <img src="${pageContext.request.contextPath }/user/images/404_01.png" alt=""/> </section>
 
<section class="content-holder1 inner-pages">
<section class="container">
<section class="help-holder">
<article class="left">
<h3>Request For Garbage Allocation In Your Area..  </h3>

<form action="<%=request.getContextPath()%>/U_Garbage_allocate_Controller" method="post">
<ul class="comm-list">
