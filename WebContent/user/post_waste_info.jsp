...
<article class="left">
<h3>Post Information about Waste</h3>

<form action="<%=request.getContextPath()%>/U_Wsate_Info_Controller" method="post">
<ul class="comm-list">
...
<li>
<label>Waste Informaiton</label>
<input name="w_info" id="name" type="text" class="comm-field">
</li>
