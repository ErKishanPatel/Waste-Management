...
<article class="left">
<h3>Please Feedback Us..</h3>

<form action="<%=request.getContextPath()%>/U_Feedback_Controller" method="post">
<ul class="comm-list">
<li>
...
<textarea name="des" id="comments" cols="4" rows="20" class="comm-area"></textarea>
</li>
<li>
